...
def generate_time_series_psi_real(grid, psi, num_time_steps):
    """Generates sample time-series graph data."""
    data = []
    for t in range(num_time_steps):
        data.append(np.column_stack((grid, np.real(psi[t]))))
...
def generate_time_series_psi_squared(grid, psi, num_time_steps):
    """Generates sample time-series graph data."""
    data = []
    for t in range(num_time_steps):
